  ...
  return (
    <div className="bg-gray-800 max-w-screen-md mx-auto my-10 py-2 rounded-md">
      ...
      {authenticated && post.author?.id === userId && (
        <>
          <button onClick={handleEditClick} className='block mx-auto px-3 my-2 p-1 border rounded-md border-gray-200 hover:text-blue-500 hover:border-blue-500 transition-colors duration-300'>
      ...
      {post.published && (
        <>
          ...
          <button onClick={handleWatchClick} className='block px-3 mx-auto my-2 p-1 border rounded-md border-gray-200 hover:text-blue-500 hover:border-blue-500 transition-colors duration-300'>
            {viewMessage}
          </button>
        </>
      )}
